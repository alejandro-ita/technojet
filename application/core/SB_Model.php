...
class SB_Model extends CI_Model {
	...
	private function load_db_template() {
		...
		$this->tbl['pi_mostrador'] 				= "$technojet.tbl_pi_mostrador";
		...
		$this->tbl['solicitud_entrega'] 		= "$technojet.tbl_solicitud_entrega";
		$this->tbl['solicitud_entrega_prod'] 	= "$technojet.tbl_solicitud_entrega_productos";
		$this->tbl['solicitud_recoleccion'] 	= "$technojet.tbl_solicitud_recoleccion";
		$this->tbl['solicitud_recoleccion_prod']= "$technojet.tbl_solicitud_recoleccion_productos";
		$this->tbl['complementos_pago']			= "$technojet.tbl_complementos_pago";
