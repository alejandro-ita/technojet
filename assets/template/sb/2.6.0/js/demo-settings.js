    ...
    i.Demo = {
        ...
        apply: function() {
            ...
            try {
                for (t.s(); !(e = t.n()).done; ) {
                    var r, o, a = e.value;
                    "aside" !== a && "header" !== a && "style" !== a || (r = i.Demo.defs(a),
                    s(o = "aside" === a ? c : "header" === a ? f : d).removeClass(i.Demo.style("all", a)),
                    "ui-default" !== r && "is-default" !== r && s(o).addClass(r)),
        ...
        locked: function(e) {
            !0 === e ? (s(y + "[data-key=aside]").add(y + "[data-key=header]").add(y + "[data-key=skin]").addClass("disabled"),
            i.Demo.update("skin", "default", !0),
            s(y + "[data-key=skin]").removeClass("active"),
            s(y + "[data-key=skin][data-update=default]").addClass("active")) : s(y + "[data-key=aside]").add(y + "[data-key=header]").add(y + "[data-key=skin]").removeClass("disabled")
        },
        update: function(e, t, r) {
            var o, a = i.Demo.style(t, e), n = i.Demo.style("all", e);
            i.Demo.apps();
            "aside" !== e && "header" !== e || (s(o = "header" == e ? f : c).removeClass(n),
            s(o).addClass(a)),
            "mode" === e && (d.removeClass(n).removeAttr("theme"),
            a === p ? (d.addClass(a).attr("theme", "dark"),
            i.Demo.locked(!0)) : (d.addClass(a).removeAttr("theme"),
            i.Demo.locked(!1))),
            "style" === e && (d.removeClass(n),
            d.addClass(a)),
            "skin" === e && (n = i.Demo.skins(a),
            a = s("#skin-default").attr("href").replace("theme", "skins/" + n),
            "theme" === n ? s(u).remove() : 0 < s(u).length ? s(u).attr("href", a) : l.append('<link id="skin-theme" rel="stylesheet" href="' + a + '">')),
            !0 === r && i.Demo.save(e, t)
        },
        reset: function() {
            var t = i.Demo.apps();
            ...
            s(f).removeClass(i.Demo.style("all", "header"));
            ...
            try {
                for (r.s(); !(e = r.n()).done; ) {
                    ...
                    s("[data-key='" + o + "']").each(function() {
                        ...
                        "aside" !== o && "header" !== o && "style" !== o || e === v[t][o] && s(this).addClass("active"),
                        "mode" !== o && "skin" !== o || e !== a && "default" !== e || s(this).addClass("active")
                    }),
                    i.Demo.remove(o)
                }
            } catch (e) {
        ...
        load: function() {
            i.Demo.apply(),
            0 < s(y).length && s(y).each(function() {
                var e = s(this).data("update")
                  , t = s(this).data("key");
                "aside" !== t && "header" !== t && "style" !== t || e === i.Demo.defs(t) && (s(this).parent(h).find(y).removeClass("active"),
                s(this).addClass("active")),
                "mode" !== t && "skin" !== t && "dir" !== t || e != i.Demo.current("skin") && e != i.Demo.current("mode") && e != i.Demo.current("dir") || (s(this).parent(h).find(y).removeClass("active"),
                s(this).addClass("active"))
            })
        },
        trigger: function() {
