...
!function(u, p) {
    ...
    u.Toast = function(t, e, n) {
        ...
        i.ui = i.ui ? " " + i.ui : "",
        a = "" !== i.icon ? '<span class="toastr-icon"><em class="icon ' + i.icon + '"></em></span>' : "",
        "" !== (t = "" !== t ? a + '<div class="toastr-text">' + t + "</div>" : "") && (!0 === i.clear && toastr.clear(),
        a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
    ...
    u.TGL.ddmenu = function(t, e) {
        var n = t || ".nk-menu-toggle"
          ...
          , a = e ? f(t, e) : t;
        p(n).on("click", function(t) {
            (u.Win.width < d.lg || p(this).parents().hasClass(r)) && u.Toggle.dropMenu(p(this), a),
            t.preventDefault()
        })
    }
    ,
