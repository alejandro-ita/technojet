...
class Almacenes extends SB_Controller {
	...
	public function __construct() {
		...
		$this->load->model('almacen/Vales_productos_model', 'db_vales_pro');
		$this->load->model('technojet/Almacen_requisiciones_model', 'db_ar');
	}

	public function index() {
		$dataView['usos'] = $this->db_catalogos->get_usos();
		$dataView['tpl-tbl-almacen'] 		= $this->parser_view('almacen/almacenes/tpl/tpl-tbl-almacenes');
		$dataView['tpl-tbl-almacen-entrada']= $this->parser_view('almacen/almacenes/tpl/tpl-tbl-almacenes-entrada');
		$dataView['tpl-tbl-almacen-salida']	= $this->parser_view('almacen/almacenes/tpl/tpl-tbl-almacenes-salida');


		$includes 	= get_includes_vendor(['moment', 'dataTables', 'DTRowGroup', 'jQValidate']);
		$pathJS 	= get_var('path_js');
        $includes['modulo']['js'][] = ['name'=>'almacenes', 'dirname'=>"$pathJS/almacen", 'fulldir'=>TRUE];
        $includes['modulo']['js'][] = ['name'=>'almacenes-entrada', 'dirname'=>"$pathJS/almacen", 'fulldir'=>TRUE];
        $includes['modulo']['js'][] = ['name'=>'almacenes-salida', 'dirname'=>"$pathJS/almacen", 'fulldir'=>TRUE];

		$this->load_view('almacen/almacenes/almacen_view', $dataView, $includes);
	}
	...
	public function get_modal_add_vale_entrada() {
		...
		($this->input->post('id_uso')==5)
			? $this->parser_view('almacen/almacenes/tpl/modal-nuevo-entrada-activos', $dataView, FALSE)
			: $this->parser_view('almacen/almacenes/tpl/modal-nuevo-entrada', $dataView, FALSE);
	}
	...
	public function get_modal_vale_salida() {
		...
		($this->input->post('id_uso')==5)
			? $this->parser_view('almacen/almacenes/tpl/modal-nuevo-salida-activos', $dataView, FALSE)
			: $this->parser_view('almacen/almacenes/tpl/modal-nuevo-salida', $dataView, FALSE);
	}
	...
	public function get_modal_add_producto_entrada() {
		...
		if($this->input->post('id_uso')==5) {
			...
			$this->parser_view('almacen/almacenes/tpl/modal-add-producto-entrada-activos', $dataView, FALSE);

		} else $this->parser_view('almacen/almacenes/tpl/modal-add-producto-entrada', $dataView, FALSE);
	}
	...
	public function get_modal_add_producto_salida() {
		...
		if($this->input->post('id_uso')==5) {
			...
			$this->parser_view('almacen/almacenes/tpl/modal-add-producto-salida-activos', $dataView, FALSE);

		} else $this->parser_view('almacen/almacenes/tpl/modal-add-producto-salida', $dataView, FALSE);
	}
	...
	public function save_productos_entrada() {
		try {
			...
			$settings = array(
				...
				,'content_file' => $this->parser_view('almacen/almacenes/tpl/tpl-pdf-vale-entrada', $dataView)
				,'load_file' 	=> FALSE
	...
	public function save_productos_activos($tipo) {
		try {
			...
			$settings = array(
				...
				,'content_file' => $this->parser_view("almacen/almacenes/tpl/tpl-pdf-vale-{$tipo}-activos", $dataView)
				,'load_file' 	=> FALSE
				,'orientation' 	=> 'landscape'
			);
	...
	public function save_productos_salida() {
		try {
			...
			$settings = array(
				...
				,'content_file' => $this->parser_view('almacen/almacenes/tpl/tpl-pdf-vale-salida', $dataView)
				,'load_file' 	=> FALSE
				,'orientation' 	=> 'landscape'
			);
	...
	public function get_modal_edit_vale_entrada() {
		...
		($id_uso ==5)
			? $this->parser_view('almacen/almacenes/tpl/modal-editar-entrada-activos', $dataView, FALSE)
			: $this->parser_view('almacen/almacenes/tpl/modal-editar-entrada', $dataView, FALSE);
	}
	...
	public function get_modal_edit_vale_salida() {
		...
		($id_uso ==5)
			? $this->parser_view('almacen/almacenes/tpl/modal-editar-salida-activos', $dataView, FALSE)
			: $this->parser_view('almacen/almacenes/tpl/modal-editar-salida', $dataView, FALSE);
	}
